...
float ArduinoEncoder::getSpeedLeft() {
    ...
    wheelRadPerSec = wheelRadPerSec * ArduinoEncoder::getLeftDirection();
...
float ArduinoEncoder::getSpeedRight() {
    ...
    wheelRadPerSec = wheelRadPerSec * ArduinoEncoder::getRightDirection();
    return wheelRadPerSec;
}

float ArduinoEncoder::getSpeedRight(elapsed) {
...
int8_t ArduinoEncoder::getLeftDirection() { return leftDirection; }

int8_t ArduinoEncoder::getRightDirection() { return rightDirection; }
